...
const TeacherDashboard = () => {
  ...
  const imageUrls = [
    ...
    'https://ibgakiosk.com/v2/upload/teacher&student//Butten-1.png',
  ...
  [{text:'OnlineClasses ' , link: '/Online-classes' }],
  [{text:'Setup Printer' , link: '/https://www.neodynamic.com/downloads/wcpp/wcpp2.aspx' }],
