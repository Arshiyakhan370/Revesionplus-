...
const data = [
  { id: 1, link :'/chemistry-paper1', imageUrl: 'https://ibgakiosk.com/v2/upload/mainimages/2023/02/1.jpg', name: 'Paper1' },
  { id: 2, link:'/chemistry-paper1', imageUrl: 'https://ibgakiosk.com/v2/upload/mainimages/2023/02/1.jpg', name: 'Paper2' },
 
];

  const ChemistryCombridge = () => {
...
<div className='text-center mb-sm-28 mb-lg-12'>
  ...
  <Button
    ...
    style={{
      margin: '1px',
      boxShadow: '0px 4px 6px rgba(0, 0, 0, 0.1)',
      backgroundColor: location.pathname === '/chemistry-paper1' ? 'lightSkyBlue' : '',
    }}
  >
  Paper
  </Button></Link>
...
export default ChemistryCombridge