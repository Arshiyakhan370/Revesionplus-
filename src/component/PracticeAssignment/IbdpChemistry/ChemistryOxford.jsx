...
const data = [
  { id: 1, link :'/chemistry-oxford-paper1-link', imageUrl: 'https://ibgakiosk.com/v2/upload/mainimages/2023/02/1.jpg', name: 'Paper1' },
  { id: 2, link:'/chemistry-oxford-paper1-link', imageUrl: 'https://ibgakiosk.com/v2/upload/mainimages/2023/02/1.jpg', name: 'Paper2' },
 
];

  const  ChemistryOxford = () => {
...
<div className={`button text-center mt-8 ${isSmallScreen ? 'mb-28' : ''}`}>
  ...
  <Button
    ...
    style={{
      margin: '1px',
      boxShadow: '0px 4px 6px rgba(0, 0, 0, 0.1)',
      backgroundColor: location.pathname === '/chemistry-oxford-paper1-link' ? '#12b6e9' : '',
    }}
  >
  Paper
  </Button></Link>
...
export default ChemistryOxford