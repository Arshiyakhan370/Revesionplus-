...
const data = [
  { id: 1, link :'/chemistry-person-paper', imageUrl: 'https://ibgakiosk.com/v2/upload/mainimages/2023/02/1.jpg', name: 'Paper1' },
  { id: 2, link:'/chemistry-person-paper', imageUrl: 'https://ibgakiosk.com/v2/upload/mainimages/2023/02/1.jpg', name: 'Paper2' },
 
];

   const  ChemistryPerson = () => { 
...
<div className='text-center mb-sm-28 mb-lg-12'>
  ...
  <Link to='/chemistry-person-paper'>
  <Button
    variant="contained"
    style={{
      margin: '1px',
...
export default ChemistryPerson;
