...
const data = [
  { id: 1, imageUrl: 'https://ibgakiosk.com/v2/upload/mainimages/2023/02/1.jpg', name: 'What is economics?  ' },
  { id: 2, imageUrl: 'https://ibgakiosk.com/v2/upload/mainimages/2023/02/1.jpg', name: 'Microeconomics' },
  { id: 3, imageUrl: 'https://ibgakiosk.com/v2/upload/mainimages/2023/02/1.jpg', name: 'The Global economy' },
  { id: 4, imageUrl: 'https://ibgakiosk.com/v2/upload/mainimages/2023/02/1.jpg', name: 'Introduction' },
...
<div className={`button text-center mt-8 ${isSmallScreen ? 'mb-28' : ''}`}>
  ...
  <Link to='/Economic-Blink-paper-link'>
  <Button
    variant="contained"
    style={{
      margin: '1px',
