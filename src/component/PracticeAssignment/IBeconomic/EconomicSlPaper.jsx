...
const data = [
  { id: 1,link:'/Economic-paper2', imageUrl: 'https://ibgakiosk.com/v2/upload/mainimages/2023/02/1.jpg', name: 'Paper1' },

];

const   EconomicSlPaper = () => {
...
export default EconomicSlPaper