    ...
    <div>
                  ...
                  <ul>
                    <li>
                      <div className="wrap-box">
                        <Link onClick={() => openModal(ques.questionNumber)} href="#">
      ...
      <Modal show={selectedQuestion !== null} onHide={closeModal}>
        <Modal.Header closeButton>
          <Modal.Title>{`Question ${selectedQuestion}`}</Modal.Title>
        </Modal.Header>
        <Modal.Body>
       <p>question: '2 The rate of change of x with respect to y is given by 3x. Find the gradient on the graph of y against x when x = 2.',
      options: ['Option A', 'Option B', 'Option C', 'Option D', 'Option E'],</p> 
        </Modal.Body>
        <Modal.Footer>
