   ...
   <Container maxWidth='xxl' style={styles}  >
          ...
          <CardContent>
            ...
            <form className="needs-validation" noValidate onSubmit={handleSubmit}>
              <Grid container spacing={2}>
                ...
                <Grid item xs={12} md={4}>
                  <TextField fullWidth  label="User Name" placeholder="Name" name="name" value={name} onChange={(e) => setName(e.target.value)}  required   InputProps={{ style: inputStyle }}/>
                </Grid>
                <Grid item xs={12} md={4}>
                  <TextField fullWidth type="email" label="User Email" placeholder="john.doe@email.com" name="email" value={email}  onChange={(e) => setEmail(e.target.value)} required   InputProps={{ style: inputStyle }}/>
                </Grid>
                <Grid item xs={12} md={4}>
                  <TextField fullWidth label="User Mobile" placeholder="9145780000" name="mobile" value={mobile} onChange={(e) => setMobile(e.target.value)}   InputProps={{ style: inputStyle }} />
                </Grid>
                <Grid item xs={12} md={4}>
                  <Flatpickr
      ...
      />
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', margin: '16px 0' }}>
                ...
                <Button type="submit" onClick={handleSubmit} variant="contained"  sx={{color:'white',  background: 'linear-gradient(139.62deg, #002B4F 0.57%, #12b6e9 100%, #002B4F) !important'}}>
                  Add
                </Button>
              </div>
            </form>
