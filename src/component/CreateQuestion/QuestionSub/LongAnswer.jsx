...
//   const [studentEditor, setStudentEditor] = useState(false);
  ...
  return (
    <Fragment>
{/* <Card maxWidth='xxl'sx={{ p: 3,marginTop:'25px',background:'#f0f0f0', marginRight:'25px' }}>
        <CardContent> */}
        ...
        <Grid item xs={12} className=" mt-4 mb-4">
          ...
          <div className="flex flex-row justify-between">
            ...
            <FormControlLabel
              sx={{ marginLeft: "10px", padding: "20px" }}
              control={
                <Switch color="primary" onChange={handleMarks} />
              }
              label="Marks"
            />
            {marks && (
                ...
                <div className="">
                  ...
                  <div className="border border-gray-500 mb-4 bg-white">
                    <Editor
                      ...
                      wrapperClassName="wrapperClassName"
                      editorClassName="editorClassName"
                      className="border border-gray-500 pl-5 pr-5 bg-gray-400"
                      onEditorStateChange={(editorState) =>
                        handleChange(editorState)
                      }
                    />
