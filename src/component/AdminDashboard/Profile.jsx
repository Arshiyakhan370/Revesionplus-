...
const ProfileForm = ({ onSave, isSidebarClosed }) => {
    ...
    const handleLogin = async () => {
        try {
            const response = await axios.post('https://staging.ibgakiosk.com/api/login', {
                ...
                <Grid container spacing={2}>
                    ...
                    <Grid item xs={12} >
                        <div className="d-flex justify-content-between">
                            ...
                            <Button variant="contained" color="primary" onClick={handleLogin} style={{ background: 'linear-gradient(139.62deg, #002B4F 0.57%, #12b6e9 100%, #002B4F) !important' }}>
                                Save Profile
                            </Button>
                        </div>
                    </Grid>
